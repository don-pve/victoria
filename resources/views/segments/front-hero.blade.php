<section id="hero" class="hero section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row align-items-center mb-5">
          <div class="offset-6 col-lg-6 mb-4 mb-lg-0">
            ...
            <h1 class="hero-title mb-4">Explore Victoria’s Premier Fishing Spots and Stories</h1>
          ...
          <div class="col-lg-6">
            {{-- <div class="hero-image">
              <img src="{{ asset('img/illustration/illustration-16.webp') }}" alt="Business Growth" class="img-fluid" loading="lazy">
            </div> --}}
          </div>
        </div>
